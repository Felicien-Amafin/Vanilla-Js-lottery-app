...
`To install the project: first run "npm install".To launch the project in local server: run "npm run serv"` or click here: [https://noteapp-5e437.web.app/](https://lotteryapp-8c92c.web.app/)
<br/>
<br/>
